...
var cssTasks = function(filename) {
    ...
    }).pipe(cssNano, {safe: true}).pipe(function() {
        return gulpif(enabled.rev, rev());
    }).pipe(function() {
        return gulpif(enabled.maps, sourcemaps.write('.', {sourceRoot: 'assets/styles/'}));
    })();
};
...
var jsTasks = function(filename) {
    return lazypipe().pipe(function() {
        ...
        return gulpif(enabled.maps, sourcemaps.write('.', {sourceRoot: 'assets/scripts/'}));
    })();
};
...
var writeToManifest = function(directory) {
    return lazypipe().pipe(gulp.dest, path.dist + directory).pipe(browserSync.stream, {match: '**/*.{js,css}'}).pipe(rev.manifest, revManifest, {
        base: path.dist,
        merge: true
...
gulp.task('watch', function() {
    ...
    gulp.watch([
        'bower.json', 'assets/manifest.json'
    ], ['build']);
});
