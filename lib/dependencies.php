...
namespace Roots\Sage\Dependencies;
...
function register_required_plugins() {
	 ...
	 */
	 $plugins = array(
		...
		array(
			'name'               => 'Kehittämö Share Buttons', // The plugin name.
			'slug'               => 'kehittamo-share-buttons', // The plugin slug (typically the folder name).
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		),
		array(
			'name'               => 'The SEO Framework', // The plugin name.
			'slug'               => 'the-seo-framework', // The plugin slug (typically the folder name).
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		),
 	 ...
 	 */
 	$config = array(
 		'id'           => 'toukoaalto2017',       // Unique ID for hashing notices for multiple instances of TGMPA.
